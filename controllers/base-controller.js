const { logger, getModulePath } = require('../routes/middlewares/logger-winston');
...
class BaseController {
    ...
    constructor(module) {
        if(module) {
            ...
            throw new Error('Require extends file module throught contructor: ' + this.constructor.name);
        }
    }
    /**
     * @function
